class ICE
{
  ...
  /*class firstAid
  {
	...
	class gameModes
	{
		...
		class AAD
		{
			attackerTicketsPerZoneCapture = 65;
        ...
        #define __unlimited -99
            kits[] =
            {
                // BLUFOR or ALL factions
                {
                    ...
                    {__ICE_gear_Grenadier, "Grenadier", 6, 1, 0, 3, 1},
                    {__ICE_gear_MG, "MG", 6, 1, 0, 3, 1},
                    {__ICE_gear_Medic, "Medic", 4, 2, 0, 3, 1},
                    {__ICE_gear_CombatEngineer, "Combat Engineer", 7, 1, 0, 3},
                    {__ICE_gear_LightAT, "Light AT", 4, 0, 0, 4, 1},
                    {__ICE_gear_HeavyAT, "Heavy AT", 8, 0, 0, 4, 1},
                    {__ICE_gear_AA, "Anti-Air", 10, 0, 0, 3, 1},
				...
				// OPFOR (delete OPFOR array or leave OPFOR array empty, to re-use (copy) BLUFOR array for both sides)
                {
                    ...
                    {__ICE_gear_CombatEngineer, "Combat Engineer", 7, 1, 0, 3},
                    {__ICE_gear_LightAT, "Light AT", 4, 0, 0, 4, 1},
                    {__ICE_gear_HeavyAT, "Heavy AT", 8, 0, 0, 0},
                    {__ICE_gear_AA, "Anti-Air", 10, 0, 0, 3, 1},
                    {__ICE_gear_Marksman, "Marksman", 10, 0, 0, 4, 1},
                    {__ICE_gear_Sniper, "Sniper", 12, 0, 0, 2, 1},
                    {__ICE_gear_SL, "Squad Leader", __unlimited, 0},
