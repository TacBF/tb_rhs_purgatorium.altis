class cfgMagazines
{
	class magazineLimitations
	{
		...
		class HE_Rockets
		{
			magazineArray[] = {"RPG32_HE_F", "rhs_rpg7_TBG7V_mag", "rhs_rpg7_OG70V_mag", "rhs_rpg7_PG7VL_mag", "rhs_rpg7_PG7VR_mag", "CUP_SMAW_HEDP_M", "CUP_SMAW_HEAA_M", "CUP_MAAWS_HEAT_M", "CUP_MAAWS_HEDP_M", "CUP_OG7_M"};
			limit = 3;
			limtResistance = 3;
